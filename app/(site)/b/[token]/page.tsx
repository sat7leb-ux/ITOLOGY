    ...
    <div className="min-h-screen bg-paper">
      ...
      <header className="border-b border-hairline bg-surface">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Badge variant={(statusVariants as Record<string, any>)[booking.status] ?? "default"}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="card p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            <div className="flex items-start gap-3">
              <div className="text-teal shrink-0 mt-0.5">{(methodIcons as Record<string, any>)[booking.meeting_method]}</div>
              <div>
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/book/demo/strategy-call">
            <Button variant="outline"><Calendar className="h-4 w-4" /> Book another</Button>
          </Link>
          <Link href={`/b/${token}`}>
            <Button variant="outline"><ExternalLink className="h-4 w-4" /> Manage booking</Button>
          </Link>
        </div>
      </div>
